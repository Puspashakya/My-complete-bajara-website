...
<body>
                ...
                <tbody>
                  ...
                  ?>
                        <tr>
                          ...
                          <td>Rs. <?php echo $data[$i][0]['item_price'] ?></td>
                          <td><?php echo $_SESSION['cart'][$i]['quantity'] ?></td>
                          <td>Rs. <?php echo ($data[$i][0]['item_price'] * $_SESSION['cart'][$i]['quantity']) ?></td>
              ...
              <div class="col">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6 text-right">
                    ...
                    for ($i = 0; $i < $num; $i++) {
                      if (isset($data[$i])) {
                    ?>
                        <strong class="text-black">Rs. <?php echo ($data[$i][0]['item_price'] * $_SESSION['cart'][$i]['quantity']) ?></strong> <br>
                    <?php
                      }
                    }
                ...
                <div class="row mb-5">
                  ...
                  <div class="col-md-6 text-right font-weight-bold">
                    <strong class="text-black">Rs. <?php echo total_price($data); ?></strong>
                  </div>
                </div>

                <div class="row">
                  <div class="col-md-6">
                    <button onclick="window.location='store.php'">More shopping</button>
                  </div>
                  <br> <br>
                  <div class="col-md-6">
                    <button onclick="window.location='checkout.php'">Make purchase</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  ?>
    <h1 style="text-align: center; color:black; ">Shopping Cart is empty</h1>
