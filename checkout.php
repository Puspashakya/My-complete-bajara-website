                  ...
                  <table class="table site-block-order-table mb-5">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-black">Rs. <?php echo total_price($data) ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="text-black font-weight-bold"><strong>Rs. <?php echo delivery_fees($data) + total_price($data) ?></strong></td>
                      </tr>
                    </tbody>
                  </table>
